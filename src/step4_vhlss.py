...
# Input Files
FILE_SURVEY_DATA = os.path.join(DATA_DIR, 'survey_responses_VHLSS.csv')   
...
# Output
OUTPUT_FILE = os.path.join(DATA_DIR, "step4_vhlss.csv")
OUTPUT_XLSX = os.path.join(DATA_DIR, "step4_vhlss_report.xlsx")
